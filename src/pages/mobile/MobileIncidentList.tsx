  ...
  return (
    <div className="pb-4">
      <div className="px-4 pt-4 pb-2 flex items-center justify-between gap-2">
        ...
        <button onClick={() => setWizardOpen(true)} className="w-11 h-11 flex items-center justify-center rounded-full bg-signal-red text-white flex-shrink-0" aria-label="Report incident">
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center justify-center py-16 px-6 text-center">
          ...
          <div className="text-[15px] font-semibold text-n-100">No incidents reported</div>
          <div className="text-13 text-n-70 mt-1">Tap the + button to report one.</div>
        </div>
      ) : (
        <div className="mt-1">
